...
public class UI{
	...
	/**
	 * Order interface for both walk ins and customers with reservations
	 * @param custlist
	 * @param tablelist
	 */
	private static void MakeOrder(CustomerList custlist , TableList tablelist) {
		boolean val=false;
		do {
		System.out.println(
				"+--------------------------------------+");
	...
	/**
	 * Creates a new customer with only the necessary customer details, proceeds with ordering and payment 
	 * @param custlist
	 * @param tablelist
	 */
	private static void walkIns(CustomerList custlist , TableList tablelist) {
		...
		while(error) {
			...
			error=false;
				...
				staff.main(customer);
				OrderInvoice invoice=new OrderInvoice();
				invoice.printInvoice(customerId,custlist);
